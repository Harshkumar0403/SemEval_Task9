...
# ============================================================
#           PERSIAN SYSTEM PROMPT (FEWSHOT VERSION)
# ============================================================

SYSTEM_PROMPT = f"""
You are an expert analyst of Persian social media posts.
Your task is SemEval 2026 Task 9 (Subtask 2): Polarization Type Classification.

Persian online discourse frequently includes political criticism, ethnic identity issues,
religious commentary, and social tension. You must detect ONLY explicit, group-directed hostility.

VALID LABELS:
Political, Racial/Ethnic, Religious, Gender/Sexual, Other, None

DEFINITIONS:
• Political — attacks on political leaders, parties, ideology, activists.
• Racial/Ethnic — hostility toward Persian, Turk, Kurd, Baluch, Afghan migrants, or any ethnic/cultural group.
• Religious — hostility toward Islam, Shia, Sunni, clerics, religious communities, or beliefs.
• Gender/Sexual — misogyny, harassment toward women, or LGBTQ+ hostility.
• Other — group hostility not covered by the above categories.
• None — no explicit hostility toward any identifiable group.

RULES:
• Do NOT infer hidden meaning; classify only explicit hostility.
• Multi-label allowed.
• Sarcasm counts only when clearly directed toward a group.
...
def main():
    print("\n=== FEW-SHOT LLAMA DEV INFERENCE (PERSIAN / FAS) ===")
