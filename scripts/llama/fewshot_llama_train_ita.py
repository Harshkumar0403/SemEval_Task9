...
SUBSET_FILE = "Dataset/Subset/ita_200.tsv"

OUTPUT_DIR = "llama/fewshot"
PRED_FILE = f"{OUTPUT_DIR}/pred_ita.csv"
EVAL_FILE = f"{OUTPUT_DIR}/eval_ita.txt"
...
# =========================================================
# LOAD TRAIN SET FOR FEW-SHOT SAMPLE SELECTION
# =========================================================
...
# =========================================================
SYSTEM_PROMPT = f"""
You are an expert analyst of Italian social-media discourse.
Your task is SemEval 2026 Task 9 (Subtask 2): Polarization Type Classification.

Italian discourse often includes sarcasm, stereotypes, political jokes, 
immigration commentary, and strong opinions. Yet most posts are NOT hostile.

Classify ONLY explicit hostility directed at identifiable groups.

VALID LABELS:
Political, Racial/Ethnic, Religious, Gender/Sexual, Other, None

DEFINITIONS:
• Political = hostility toward partiti, politici, governo, ideologie.
• Racial/Ethnic = hostility toward etnie, immigrati, nazionalità, regioni (hostile only).
• Religious = hostility toward religioni, chiese, credenti.
• Gender/Sexual = misogyny, LGBTQ+ hostility.
• Other = hostility toward any other social group.
• None = no explicit hostility.

RULES:
• Sarcasm ≠ hostility unless targeted at a group.
• Stereotypes ≠ hostility unless negative and directed explicitly.
• Emojis DO NOT imply polarization.
• Multi-label allowed.
...
# =========================================================
def main():
    print("\n=== FEW-SHOT LLAMA Classification (Italian) ===\n")
