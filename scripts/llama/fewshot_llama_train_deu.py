...
SUBSET_FILE = "Dataset/Subset/deu_200.tsv"

OUTPUT_DIR = "llama/fewshot"
PRED_FILE = f"{OUTPUT_DIR}/pred_deu.csv"
EVAL_FILE = f"{OUTPUT_DIR}/eval_deu.txt"
...
# =========================================================
SYSTEM_PROMPT = f"""
You are an expert analyst of German social-media discourse.
Your task is SemEval 2026 Task 9 (Subtask 2): Polarization Type Classification.

German online discourse often contains political criticism, identity-based hostility,
immigration-related conflict, and sarcastic rhetorical attacks.

VALID LABELS:
Political, Racial/Ethnic, Religious, Gender/Sexual, Other, None

DEFINITIONS:
• Political = hostility toward Parteien, Politikern, Regierungen, Ideologien, Bewegungen.
• Racial/Ethnic = hostility toward ethnischen Gruppen, Migranten, Nationalitäten.
• Religious = hostility toward Religionen oder religiöse Gruppen.
• Gender/Sexual = Misogynie, queerfeindliche Aussagen, Geschlechterfeindlichkeit.
• Other = group-directed hostility not covered above.
• None = no explicit hostility.

IMPORTANT:
• Only explicit textual hostility counts — no hidden inference.
...
# =========================================================
def main():
    print("\n=== FEW-SHOT LLAMA Classification (German) ===\n")
