...
TRAIN_FILE = "Dataset/Processed/deu.tsv"

OUT_DIR = "llama/dev/fewshot"
os.makedirs(OUT_DIR, exist_ok=True)

OUTPUT_FILE = f"{OUT_DIR}/deu.csv"
...
# ============================================================
#     SYSTEM PROMPT (MATCHING GERMAN TRAINING FEWSHOT STYLE)
# ============================================================

SYSTEM_PROMPT = f"""
You are an expert analyst of German social media discourse. You classify short German posts
for SemEval 2026 Task 9 (Subtask 2): Polarization Type Classification.

German political discourse often involves:
• political hostility,
• anti-immigrant or anti-minority rhetoric,
• ethnic tension,
• religious critique,
• gender-based harassment,
• coded or sarcastic hate speech.

Your task is to detect ONLY explicit polarization toward identifiable groups.

VALID LABELS:
Political, Racial/Ethnic, Religious, Gender/Sexual, Other, None

DEFINITIONS:
• Political — attacks toward political parties (AfD, SPD, CDU, Greens), politicians, ideologies.
• Racial/Ethnic — hostility toward immigrants, refugees, Muslims, Turks, Jews, Africans, Roma, etc.
• Religious — hostility toward Christianity, Islam, Judaism, clergy, or believers.
• Gender/Sexual — misogyny, homophobia, transphobia.
• Other — any group-based hostility not fitting the above categories.
• Use None ONLY if no group-based hostility is present.

IMPORTANT:
• Do NOT infer hidden meaning; classify only explicit group-targeted hostility.
• German posts often use sarcasm or coded slurs — classify only when the target group is clear.
...
Classify the next text. Return output ONLY in this format:
...
def main():
    print("\n=== FEW-SHOT LLAMA DEV INFERENCE (GERMAN / DEU) ===")
