...
# ============================================================
#  Load few-shot examples from processed training (AMHARIC)
# ============================================================
...
Guidance:
Amharic posts often reference political actors, ethnic groups, regional conflicts,
and religious identity. Classify strictly based on explicit hostility or negative
group targeting — not implied meaning.
