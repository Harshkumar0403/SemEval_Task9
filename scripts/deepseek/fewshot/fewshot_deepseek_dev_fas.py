...
# ============================================================
SYSTEM_PROMPT = f"""
You are an expert analyst of Persian (Farsi) social-media discourse. You classify short posts
...
Guidance:
Persian social-media posts often contain political criticism (government, leaders, ideology),
ethnic hostility (Kurds, Baluch, Azeri, etc.), religious targeting, and gender-based harassment.
Label ONLY explicit group-directed hostility, not general negativity.
