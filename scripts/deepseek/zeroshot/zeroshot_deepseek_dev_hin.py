...
# ============================================================
# SYSTEM PROMPT (Hindi — expert moderation classifier)
# ============================================================
SYSTEM_PROMPT = """
You are an expert analyst specializing in detecting hateful, abusive, or targeted
content in Hindi social-media posts. You must classify each post into ANY number
...
Hindi posts may contain sarcasm, slang, political insults, communal references,
gender-based harassment, caste-based hostility, or community-targeted attacks.
Be strict when clear hostility is directed toward any identifiable group.
"""
