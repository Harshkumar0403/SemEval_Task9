...
MAX_EXAMPLES = 10
SLEEP_TIME = 0.01  # obey rate limits
...
# ============================================================
SYSTEM_PROMPT = f"""
You are an expert analyst of Turkish social media discourse. Your task is to classify each post
into ANY number of the following labels (multi-label is allowed):
...
4. Gender/Sexual
5. Other
6. None — ONLY if no targeted or abusive group-based content exists.
...
Guidelines:
Turkish posts often include political hostility (government, parties, leaders), ethnic conflict
(Kurdish/Turkish tensions), religious insults, gender-based harassment, and other forms of
targeted abuse. Label ONLY explicit group-directed hostility.
