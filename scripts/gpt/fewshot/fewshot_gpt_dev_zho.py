...
MAX_EXAMPLES = 10
SLEEP_TIME = 0.01  # satisfies 100 rpm limit
...
# ============================================================
SYSTEM_PROMPT = f"""
You are an expert analyst of Chinese social-media discourse. Your task is to classify each
...
4. Gender/Sexual
5. Other
6. None — ONLY if the text contains no group-targeted hostility

Guidance:
Chinese posts are often extremely short (sometimes just 1–3 characters), but may still contain
clear targeted hostility toward political groups, ethnic identities, religions, gender/sexuality,
or other social groups. Assign a label ONLY when explicit group hostility is present.

Rules:
- Output MUST be ONLY a JSON list, e.g.: ["Political", "Racial/Ethnic"]
...
# ============================================================
#     CONVERT LABELS TO BINARY VECTORS FOR EXPORT
# ============================================================
