...
MAX_EXAMPLES = 10
SLEEP_TIME = 0.01  # pacing 100 rpm
...
# ============================================================
#               SYSTEM PROMPT (Nepali)
# ============================================================
SYSTEM_PROMPT = f"""
You are an expert analyst of Nepali social-media discourse. You classify short Nepali posts
for hateful, abusive, or group-targeted content into ANY number of categories (multi-label):
...
4. Gender/Sexual
5. Other
6. None — ONLY if absolutely no harmful or targeted content exists.

Rules:
- Output MUST be a JSON list: ["Political", "Religious"].
- No explanations, no prose.
- If nothing applies, return ["None"].

Guidance:
Nepali posts frequently mention political parties, leaders, caste groups, ethnic minorities,
regional identities, religious groups, and gender-based harassment.
Label ONLY explicit group-directed hostility, not general complaining or sarcasm.
