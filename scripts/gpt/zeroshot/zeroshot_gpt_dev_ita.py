...
# ============================================================
# SYSTEM PROMPT (Italian — expert moderation classifier)
# ============================================================
SYSTEM_PROMPT = """
...
Italian posts may include political insults, xenophobic terms, regional stereotypes,
anti-immigrant rhetoric, religious hostility, or gender/sexual harassment.
Be strict when hostility is directed at any identifiable social group.
"""
...
def run_inference():
    ...
    for _, row in tqdm(df.iterrows(), total=len(df)):
        ...
        time.sleep(0.01)  # ~100 RPM protection
