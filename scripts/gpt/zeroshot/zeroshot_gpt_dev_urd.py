...
if api_key is None:
    raise ValueError("Error: OPENAI_API_KEY missing. Please export it first.")

client = OpenAI(api_key=api_key)

# ============================================================
# SYSTEM PROMPT (Urdu specialization)
# ============================================================
SYSTEM_PROMPT = """
You are an expert social-media moderation analyst specializing in harmful, abusive,
and targeted content in Urdu posts. You must classify each post into ANY number of
the following categories (multi-label allowed):
...
- Do NOT output prose or comments.

Urdu social-media posts may include political hostility, sectarian religious slurs,
ethnic targeting, misogyny, harassment, and other group-directed abuse. Label ONLY
when the hostility is directed at an identifiable group.
"""
...
def extract_json_list(text):
    ...
    # Try extracting [...]-style JSON from the text
...
def gpt_predict(text):
    ...
    return []  # fallback if total failure
